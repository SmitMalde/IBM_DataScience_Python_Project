This project is completed as a part of the "Python Project for Data Science" by IBM.

Language used: Python
Libraries used: Numpy, Pandas, yFinance, Plotlib, BeautifulSoup

For this project, we assume the role of a Data Scientist / Data Analyst working for a new startup investment firm that helps customers invest their money in stocks. 
